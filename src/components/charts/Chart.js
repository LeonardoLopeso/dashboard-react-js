...
const Graphic = () => {
  return (
    <Chart id="chart" palette="Vintage" dataSource={populationData}>
      <CommonSeriesSettings argumentField="time" type="fullstackedbar" />
      ...
      <ValueAxis name="TmpChamada" position="right" title="Tempo Chamadas">
        <Grid visible={true} />
      </ValueAxis>
